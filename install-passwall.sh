...
wget --no-check-certificate "https://github.com/wegare123/Passwall-Openclash/blob/main/passwall.zip?raw=true" -O ~/ekstrak.zip && unzip ~/ekstrak.zip && opkg install --force-depends *.ipk && rm -rf ekstrak.zip
