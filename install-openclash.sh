...
wget --no-check-certificate "https://github.com/wegare123/Passwall-Openclash/blob/main/openclash.zip?raw=true" -O ~/ekstrak.zip && unzip ~/ekstrak.zip && opkg install --force-depends *.ipk && rm -rf ekstrak.zip
